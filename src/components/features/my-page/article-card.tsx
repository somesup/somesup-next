  ...
  return (
    <a href={`/scrap?index=${index}`} className="relative block overflow-hidden rounded-xl">
      <div
        ...
        className="relative aspect-[10/16] w-full bg-cover bg-center bg-no-repeat"
      >
        <div className="absolute inset-0 bg-[linear-gradient(to_top,theme(colors.gray.10)_0%,theme(colors.gray.10/0.4)_43%,transparent_64%,transparent_100%)]" />
